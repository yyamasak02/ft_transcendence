...
export function activateAbility(playerId: number, charIndex: number, abilityType: string) {
    ...
    switch (abilityType) {
        ...
        case 'suicider':
            ...
            console.log(`Player ${playerId} Suicider position switched:`, player.isSuiciderActive);
            break;
