...
export const en = {
  ...
  failed: "Failed!",
	...
	privacy_5_s2: "Accounts may be deleted upon request where technically feasible. User data may be retained for the duration of the project.",
	privacy_5_s3: "User data may be retained for the duration of the project. Users may request deletion of their account and associated data by contacting the project team. Deletion requests will be processed where technically feasible.",
