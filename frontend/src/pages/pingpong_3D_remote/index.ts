...
export const PingPong3DGameRemoteRoute: Routes = {
  "/pingpong_3D_remote": {
    linkLabel: () => word("pingpong3d_remote"),
    ...
    onMount: () => {
      ...
      const btnPause =
        gameRoot.querySelector<HTMLButtonElement>("#btn-3d-pause");
      const btnResume =
        gameRoot.querySelector<HTMLButtonElement>("#btn-3d-resume");
      const btnReset =
        gameRoot.querySelector<HTMLButtonElement>("#btn-3d-reset");
